...
int main(int argc, char *argv[])
{
  ...
  while (1)
  {
    ...
    else if (WIFSTOPPED(status))
    {
      ...
      char *syscall_name = get_system_call_name(syscall_number);
